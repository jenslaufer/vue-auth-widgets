...
import { ref as q, onMounted as K, createElementBlock as l, openBlock as a, Fragment as v, createElementVNode as r, createCommentVNode as p, normalizeClass as i, toDisplayString as b, withDirectives as $, vModelText as k, unref as u, renderList as w, createBlock as L, createTextVNode as M } from "vue";
import V from "axios";
...
const D = { class: "mb-4" }, R = { class: "mb-6" }, F = ["disabled"], U = "api-key-change", T = {
  ...
  setup(e, { emit: h }) {
    const f = e, y = h, o = q(""), g = q({
      ...
      try {
        let s, t;
        if (s = await V.get(`${f.baseUrl}/user?where=${encodeURIComponent(JSON.stringify(c))}`), !s.data._items || s.data._items.length === 0) {
          o.value = "Invalid login";
          return;
        }
        t = s.data._items[0].key, m(t);
      } catch (s) {
        o.value = `${s}`;
      }
    };
    return K(() => {
      ...
      c[2] || (c[2] = r("h2", { class: "text-2xl font-bold mb-6 text-center" }, "Login", -1)),
      o.value ? (a(), l("p", {
        key: 0,
      ...
      r("div", D, [
        ...
        u(d).email.$errors.length ? (a(), l("div", {
          key: 0,
          class: i(e.errorMessageClass)
        }, [
          (a(!0), l(v, null, w(u(d).email.$errors, (s) => (a(), l("div", {
            key: s.$uid
          }, b(s.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
      r("div", R, [
        ...
        u(d).password.$errors.length ? (a(), l("div", {
          key: 0,
          class: i(e.errorMessageClass)
        }, [
          (a(!0), l(v, null, w(u(d).password.$errors, (s) => (a(), l("div", {
            key: s.$uid
          }, b(s.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
  ...
  emits: [E],
  setup(e, { emit: h }) {
    const f = e, y = h, o = q(""), g = q(crypto.randomUUID()), n = q({
      firstName: "",
      lastName: "",
      email: "",
      password: ""
    ...
    return K(() => {
      ...
      r("div", P, [
        ...
        u(m).firstName.$errors.length ? (a(), l("div", {
          key: 0,
          class: i(e.errorMessageClass)
        }, [
          (a(!0), l(v, null, w(u(m).firstName.$errors, (t) => (a(), l("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
      r("div", G, [
        ...
        u(m).lastName.$errors.length ? (a(), l("div", {
          key: 0,
          class: i(e.errorMessageClass)
        }, [
          (a(!0), l(v, null, w(u(m).lastName.$errors, (t) => (a(), l("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
      r("div", H, [
        ...
        u(m).email.$errors.length ? (a(), l("div", {
          key: 0,
          class: i(e.errorMessageClass)
        }, [
          (a(!0), l(v, null, w(u(m).email.$errors, (t) => (a(), l("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
      r("div", O, [
        ...
        $(r("input", {
          ...
          class: i([
            `${e.inputClass}`,
            u(m).password.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
          ]),
          required: ""
        }, null, 2), [
          [k, n.value.password]
        ]),
        u(m).password.$errors.length ? (a(), l("div", {
          key: 0,
          class: i(e.errorMessageClass)
        }, [
          (a(!0), l(v, null, w(u(m).password.$errors, (t) => (a(), l("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
