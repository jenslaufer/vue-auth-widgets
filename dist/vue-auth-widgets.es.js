...
import { ref as q, onMounted as K, createElementBlock as a, openBlock as r, Fragment as f, createElementVNode as l, createCommentVNode as v, normalizeClass as i, toDisplayString as b, withDirectives as C, unref as u, vModelText as k, renderList as w, createBlock as L, createTextVNode as M } from "vue";
import V from "axios";
...
const D = { class: "mb-4" }, R = { class: "mb-6" }, F = ["disabled"], U = "api-key-change", T = {
  ...
  setup(e, { emit: h }) {
    const p = e, y = h, m = q(""), g = q({
      ...
      const o = {
        ...
        "credentials.product": p.productName,
        password: g.value.password
      };
      try {
        let s, t;
        if (s = await V.get(`${p.baseUrl}/user?where=${encodeURIComponent(JSON.stringify(o))}`), !s.data._items || s.data._items.length === 0) {
          m.value = "Invalid login";
          return;
        }
        t = s.data._items[0].key, c(t);
      } catch (s) {
        m.value = `${s}`;
      }
    };
    return K(() => {
      ...
      o[2] || (o[2] = l("h2", { class: "text-2xl font-bold mb-6 text-center" }, "Login", -1)),
      m.value ? (r(), a("p", {
        key: 0,
      ...
      l("div", D, [
        ...
        C(l("input", {
          type: "email",
          id: "email",
          "onUpdate:modelValue": o[0] || (o[0] = (s) => g.value.email = s),
          class: i([
            `${e.inputClass}`,
        ...
        u(d).email.$errors.length ? (r(), a("div", {
          ...
          (r(!0), a(f, null, w(u(d).email.$errors, (s) => (r(), a("div", {
            key: s.$uid
          }, b(s.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      l("div", R, [
        ...
        C(l("input", {
          type: "password",
          id: "password",
          "onUpdate:modelValue": o[1] || (o[1] = (s) => g.value.password = s),
          class: i([
            `${e.inputClass}`,
        ...
        u(d).password.$errors.length ? (r(), a("div", {
          ...
          (r(!0), a(f, null, w(u(d).password.$errors, (s) => (r(), a("div", {
            key: s.$uid
          }, b(s.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
  ...
  emits: [E],
  setup(e, { emit: h }) {
    const p = e, y = h, m = q(""), g = q(crypto.randomUUID()), n = q({
      firstName: "",
      lastName: "",
      email: "",
      password: ""
      ...
      const s = {
        "credentials.email": n.value.email,
        "credentials.product": p.productName,
      ...
      try {
        let t;
        s.firstname = n.value.firstName, s.lastname = n.value.lastName, await V.post(`${p.baseUrl}/user`, s, {
    ...
    return K(() => {
      ...
      l("div", P, [
        ...
        C(l("input", {
          type: "text",
          id: "firstName",
          "onUpdate:modelValue": s[0] || (s[0] = (t) => n.value.firstName = t),
          class: i([
            `${e.inputClass}`,
            o.v$.firstName.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
          ]),
          required: ""
        }, null, 2), [
          [k, n.value.firstName]
        ...
        u(c).firstName.$errors.length ? (r(), a("div", {
          ...
          (r(!0), a(f, null, w(u(c).firstName.$errors, (t) => (r(), a("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      l("div", G, [
        ...
        C(l("input", {
          type: "text",
          id: "lastName",
          "onUpdate:modelValue": s[1] || (s[1] = (t) => n.value.lastName = t),
          class: i([
            `${e.inputClass}`,
            o.v$.lastName.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
          ]),
          required: ""
        }, null, 2), [
          [k, n.value.lastName]
        ...
        u(c).lastName.$errors.length ? (r(), a("div", {
          ...
          (r(!0), a(f, null, w(u(c).lastName.$errors, (t) => (r(), a("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      l("div", H, [
        ...
        C(l("input", {
          type: "email",
          id: "email",
          "onUpdate:modelValue": s[2] || (s[2] = (t) => n.value.email = t),
          class: i([
            `${e.inputClass}`,
            o.v$.email.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
          ]),
          required: ""
        }, null, 2), [
          [k, n.value.email]
        ...
        u(c).email.$errors.length ? (r(), a("div", {
          ...
          (r(!0), a(f, null, w(u(c).email.$errors, (t) => (r(), a("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      l("div", O, [
        ...
        u(c).password.$errors.length ? (r(), a("div", {
          ...
          (r(!0), a(f, null, w(u(c).password.$errors, (t) => (r(), a("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
