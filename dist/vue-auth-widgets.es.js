...
import { ref as C, onMounted as M, openBlock as r, createElementBlock as a, Fragment as p, createElementVNode as l, normalizeClass as n, toDisplayString as b, createCommentVNode as v, withDirectives as w, unref as u, vModelText as N, renderList as q, createBlock as L, createTextVNode as U, renderSlot as D } from "vue";
import B from "axios";
...
const T = { class: "mb-4" }, P = { class: "mb-6" }, F = ["disabled"], E = "api-key-change", G = {
    ...
    return M(() => {
      ...
      l("div", T, [
        ...
        w(l("input", {
          ...
          class: n([
            `${e.inputClass}`,
            u(o).email.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
          ]),
          required: ""
        }, null, 2), [
          [N, g.value.email]
        ]),
        u(o).email.$errors.length ? (r(), a("div", {
          key: 0,
          class: n(e.errorMessageClass)
        }, [
          (r(!0), a(p, null, q(u(o).email.$errors, (t) => (r(), a("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      l("div", P, [
        ...
        w(l("input", {
          ...
          class: n([
            `${e.inputClass}`,
            u(o).password.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
          ]),
          required: ""
        }, null, 2), [
          [N, g.value.password]
        ]),
        u(o).password.$errors.length ? (r(), a("div", {
          key: 0,
          class: n(e.errorMessageClass)
        }, [
          (r(!0), a(p, null, q(u(o).password.$errors, (t) => (r(), a("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
    ...
    return M(() => {
      ...
      l("div", H, [
        ...
        w(l("input", {
          ...
          class: n([
            `${e.inputClass}`,
            u(c).firstName.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
          ]),
          required: ""
        }, null, 2), [
          [N, d.value.firstName]
        ]),
        u(c).firstName.$errors.length ? (r(), a("div", {
          key: 0,
          class: n(e.errorMessageClass)
        }, [
          (r(!0), a(p, null, q(u(c).firstName.$errors, (s) => (r(), a("div", {
            key: s.$uid
          }, b(s.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      l("div", Y, [
        ...
        w(l("input", {
          ...
          class: n([
            `${e.inputClass}`,
            u(c).lastName.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
          ]),
          required: ""
        }, null, 2), [
          [N, d.value.lastName]
        ]),
        u(c).lastName.$errors.length ? (r(), a("div", {
          key: 0,
          class: n(e.errorMessageClass)
        }, [
          (r(!0), a(p, null, q(u(c).lastName.$errors, (s) => (r(), a("div", {
            key: s.$uid
          }, b(s.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      l("div", O, [
        ...
        w(l("input", {
          ...
          class: n([
            `${e.inputClass}`,
            u(c).email.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
          ]),
          required: ""
        }, null, 2), [
          [N, d.value.email]
        ]),
        u(c).email.$errors.length ? (r(), a("div", {
          key: 0,
          class: n(e.errorMessageClass)
        }, [
          (r(!0), a(p, null, q(u(c).email.$errors, (s) => (r(), a("div", {
            key: s.$uid
          }, b(s.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      l("div", J, [
        ...
        w(l("input", {
          ...
          class: n([
            `${e.inputClass}`,
            u(c).password.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
          ]),
          required: ""
        }, null, 2), [
          [N, d.value.password]
        ]),
        u(c).password.$errors.length ? (r(), a("div", {
          key: 0,
          class: n(e.errorMessageClass)
        }, [
          (r(!0), a(p, null, q(u(c).password.$errors, (s) => (r(), a("div", {
            key: s.$uid
          }, b(s.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
  ...
  setup(e, { emit: $ }) {
    ...
    return (d, o) => (r(), a("div", Q, [
      ...
      l("div", W, [
        y.value ? (r(), a("p", X, [
          o[0] || (o[0] = U(" Don't have an account? ", -1)),
          l("button", {
            onClick: g,
            class: n(e.linkClass)
          }, b(e.registrationButtonLabel), 3)
        ])) : (r(), a("p", Z, [
          o[1] || (o[1] = U(" Do you have an account? ", -1)),
          l("button", {
            onClick: g,
            class: n(e.linkClass)
  ...
  emits: [K],
  setup(e, { emit: $ }) {
    const f = e, y = $, i = C(""), g = C(!0), d = (o) => {
      i.value = o.key, localStorage.setItem(f.keyName, i.value), g.value = !1, y(K, i.value);
    };
    return M(() => {
      i.value = localStorage.getItem(f.keyName);
      const o = /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;
      i.value && o.test(i.value) ? g.value = !1 : g.value = !0;
    }), (o, c) => g.value ? (r(), L(_, {
      key: 1,
      "product-name": e.productName,
      "base-url": e.baseUrl,
      ...
      onApiKeyChange: d
    }, null, 8, ["product-name", "base-url"])) : D(o.$slots, "default", { key: 0 });
  }
};
export {
  ae as Registered
