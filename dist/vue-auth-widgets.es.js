...
import { ref as C, onMounted as M, openBlock as r, createElementBlock as l, Fragment as p, createElementVNode as n, normalizeClass as i, toDisplayString as f, createCommentVNode as v, withDirectives as w, unref as u, vModelText as N, renderList as q, createBlock as L, createTextVNode as U, renderSlot as D } from "vue";
import I from "axios";
import { useVuelidate as R } from "@vuelidate/core";
import { required as S, email as V, minLength as x } from "@vuelidate/validators";
const T = { class: "mb-4" }, P = { class: "mb-6" }, F = ["disabled"], E = "api-key-change", G = {
  ...
  setup(e, { emit: $ }) {
    const y = e, c = $, o = C(""), m = C({
      ...
      try {
        let t, s;
        if (t = await I.get(`${y.baseUrl}/user?where=${encodeURIComponent(JSON.stringify(b))}`), !t.data._items || t.data._items.length === 0) {
    ...
    return M(() => {
      ...
      b[2] || (b[2] = n("h2", { class: "text-2xl font-bold mb-6 text-center" }, "Login", -1)),
      o.value ? (r(), l("p", {
        key: 0,
      ...
      n("div", T, [
        ...
        w(n("input", {
          type: "email",
          id: "email",
          "onUpdate:modelValue": b[0] || (b[0] = (t) => m.value.email = t),
          class: i([
            `${e.inputClass}`,
        ...
        u(d).email.$errors.length ? (r(), l("div", {
          key: 0,
          class: i(e.errorMessageClass)
        }, [
          (r(!0), l(p, null, q(u(d).email.$errors, (t) => (r(), l("div", {
            key: t.$uid
          }, f(t.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      n("div", P, [
        ...
        w(n("input", {
          type: "password",
          id: "password",
          "onUpdate:modelValue": b[1] || (b[1] = (t) => m.value.password = t),
          class: i([
            `${e.inputClass}`,
        ...
        u(d).password.$errors.length ? (r(), l("div", {
          key: 0,
          class: i(e.errorMessageClass)
        }, [
          (r(!0), l(p, null, q(u(d).password.$errors, (t) => (r(), l("div", {
            key: t.$uid
          }, f(t.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
  ...
  emits: [A],
  setup(e, { emit: $ }) {
    const y = e, c = $, o = C(""), m = C(crypto.randomUUID()), a = C({
      firstName: "",
      lastName: "",
      email: "",
      password: ""
      ...
      const t = {
        "credentials.email": a.value.email,
        "credentials.product": y.productName,
      ...
      try {
        let s;
        t.firstname = a.value.firstName, t.lastname = a.value.lastName, await I.post(`${y.baseUrl}/user`, t, {
    ...
    return M(() => {
      ...
      t[4] || (t[4] = n("h2", { class: "text-2xl font-bold mb-6 text-center" }, "Registration", -1)),
      o.value ? (r(), l("p", {
        key: 0,
        class: i(e.errorMessageClass)
      }, f(o.value), 3)) : v("", !0),
      n("div", H, [
        ...
        w(n("input", {
          type: "text",
          id: "firstName",
          "onUpdate:modelValue": t[0] || (t[0] = (s) => a.value.firstName = s),
          class: i([
            `${e.inputClass}`,
            u(g).firstName.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
          ]),
          required: ""
        }, null, 2), [
          [N, a.value.firstName]
        ]),
        u(g).firstName.$errors.length ? (r(), l("div", {
          key: 0,
          class: i(e.errorMessageClass)
        }, [
          (r(!0), l(p, null, q(u(g).firstName.$errors, (s) => (r(), l("div", {
            key: s.$uid
          }, f(s.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      n("div", Y, [
        ...
        w(n("input", {
          type: "text",
          id: "lastName",
          "onUpdate:modelValue": t[1] || (t[1] = (s) => a.value.lastName = s),
          class: i([
            `${e.inputClass}`,
            u(g).lastName.$error ? "border-red-500 focus:ring-red-500" : "border-gray-300 focus:ring-blue-500"
          ]),
          required: ""
        }, null, 2), [
          [N, a.value.lastName]
        ]),
        u(g).lastName.$errors.length ? (r(), l("div", {
          key: 0,
          class: i(e.errorMessageClass)
        }, [
          (r(!0), l(p, null, q(u(g).lastName.$errors, (s) => (r(), l("div", {
            key: s.$uid
          }, f(s.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      n("div", O, [
        ...
        w(n("input", {
          type: "email",
          id: "email",
          "onUpdate:modelValue": t[2] || (t[2] = (s) => a.value.email = s),
          class: i([
            `${e.inputClass}`,
        ...
        u(g).email.$errors.length ? (r(), l("div", {
          key: 0,
          class: i(e.errorMessageClass)
        }, [
          (r(!0), l(p, null, q(u(g).email.$errors, (s) => (r(), l("div", {
            key: s.$uid
          }, f(s.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      n("div", j, [
        ...
        w(n("input", {
          type: "password",
          id: "password",
          "onUpdate:modelValue": t[3] || (t[3] = (s) => a.value.password = s),
          class: i([
            `${e.inputClass}`,
        ...
        u(g).password.$errors.length ? (r(), l("div", {
          key: 0,
          class: i(e.errorMessageClass)
        }, [
          (r(!0), l(p, null, q(u(g).password.$errors, (s) => (r(), l("div", {
            key: s.$uid
          }, f(s.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
  ...
  setup(e, { emit: $ }) {
    ...
    return (a, d) => (r(), l("div", Q, [
      ...
      n("div", W, [
        c.value ? (r(), l("p", X, [
          d[0] || (d[0] = U(" Don't have an account? ", -1)),
          n("button", {
            onClick: m,
            class: i(e.linkClass)
          }, f(e.registrationButtonLabel), 3)
        ])) : (r(), l("p", Z, [
          d[1] || (d[1] = U(" Do you have an account? ", -1)),
          n("button", {
            onClick: m,
            class: i(e.linkClass)
  ...
  emits: [B],
  setup(e, { emit: $ }) {
    const y = $, c = C(""), o = C(!0), m = (a) => {
      c.value = a.key, localStorage.setItem(keyName, c.value), o.value = !1, y(B, c.value);
    };
    return M(() => {
      c.value = localStorage.getItem(keyName);
      const a = /^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i;
      c.value && a.test(c.value) ? o.value = !1 : o.value = !0;
    }), (a, d) => o.value ? D(a.$slots, "default", { key: 0 }) : (r(), L(_, {
      key: 1,
