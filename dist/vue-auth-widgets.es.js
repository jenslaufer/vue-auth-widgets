...
const T = { class: "mb-4" }, P = { class: "mb-6" }, F = ["disabled"], E = "api-key-change", G = {
  ...
  setup(e, { emit: $ }) {
    ...
    return M(() => {
      ...
      b[2] || (b[2] = l("h2", { class: "text-2xl font-bold mb-6 text-center" }, "Login", -1)),
      o.value ? (r(), a("p", {
        key: 0,
      ...
      l("div", T, [
        ...
        u(d).email.$errors.length ? (r(), a("div", {
          ...
          (r(!0), a(p, null, q(u(d).email.$errors, (t) => (r(), a("div", {
            key: t.$uid
          }, f(t.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      l("div", P, [
        ...
        u(d).password.$errors.length ? (r(), a("div", {
          ...
          (r(!0), a(p, null, q(u(d).password.$errors, (t) => (r(), a("div", {
            key: t.$uid
          }, f(t.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
  ...
  emits: [A],
  setup(e, { emit: $ }) {
    const y = e, c = $, o = C(""), m = C(crypto.randomUUID()), i = C({
      firstName: "",
      lastName: "",
      email: "",
      password: ""
    ...
    return M(() => {
      ...
      l("div", H, [
        ...
        w(l("input", {
          type: "text",
          id: "firstName",
          "onUpdate:modelValue": t[0] || (t[0] = (s) => i.value.firstName = s),
          class: n([
            `${e.inputClass}`,
        ...
        u(g).firstName.$errors.length ? (r(), a("div", {
          key: 0,
          class: n(e.errorMessageClass)
        }, [
          (r(!0), a(p, null, q(u(g).firstName.$errors, (s) => (r(), a("div", {
            key: s.$uid
          }, f(s.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      l("div", Y, [
        ...
        w(l("input", {
          type: "text",
          id: "lastName",
          "onUpdate:modelValue": t[1] || (t[1] = (s) => i.value.lastName = s),
          class: n([
            `${e.inputClass}`,
        ...
        u(g).lastName.$errors.length ? (r(), a("div", {
          key: 0,
          class: n(e.errorMessageClass)
        }, [
          (r(!0), a(p, null, q(u(g).lastName.$errors, (s) => (r(), a("div", {
            key: s.$uid
          }, f(s.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      l("div", O, [
        ...
        w(l("input", {
          type: "email",
          id: "email",
          "onUpdate:modelValue": t[2] || (t[2] = (s) => i.value.email = s),
          class: n([
            `${e.inputClass}`,
        ...
        u(g).email.$errors.length ? (r(), a("div", {
          ...
          (r(!0), a(p, null, q(u(g).email.$errors, (s) => (r(), a("div", {
            key: s.$uid
          }, f(s.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
      l("div", J, [
        ...
        w(l("input", {
          type: "password",
          id: "password",
          "onUpdate:modelValue": t[3] || (t[3] = (s) => i.value.password = s),
          class: n([
            `${e.inputClass}`,
        ...
        u(g).password.$errors.length ? (r(), a("div", {
          ...
          (r(!0), a(p, null, q(u(g).password.$errors, (s) => (r(), a("div", {
            key: s.$uid
          }, f(s.$message), 1))), 128))
        ], 2)) : v("", !0)
      ]),
  ...
  setup(e, { emit: $ }) {
    ...
    return M(() => {
      ...
      c.value && i.test(c.value) ? o.value = !1 : o.value = !0;
    }), (i, d) => o.value ? (r(), L(_, {
      key: 1,
      "product-name": e.productName,
      "base-url": e.baseUrl,
