...
const D = { class: "mb-4" }, R = { class: "mb-6" }, F = ["disabled"], U = "api-key-change", T = {
  ...
  setup(e, { emit: h }) {
    const f = e, y = h, u = q(""), c = q({
      ...
      try {
        let s, t;
        if (s = await V.get(`${f.baseUrl}/user?where=${encodeURIComponent(JSON.stringify(o))}`), !s.data._items || s.data._items.length === 0) {
    ...
    return K(() => {
      ...
      o[2] || (o[2] = r("h2", { class: "text-2xl font-bold mb-6 text-center" }, "Login", -1)),
      u.value ? (a(), l("p", {
        key: 0,
      ...
      r("div", D, [
        ...
        $(r("input", {
          type: "email",
          id: "email",
          "onUpdate:modelValue": o[0] || (o[0] = (s) => c.value.email = s),
        ...
        d(m).email.$errors.length ? (a(), l("div", {
          ...
          (a(!0), l(v, null, w(d(m).email.$errors, (s) => (a(), l("div", {
            key: s.$uid
          }, b(s.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
      r("div", R, [
        ...
        $(r("input", {
          type: "password",
          id: "password",
          "onUpdate:modelValue": o[1] || (o[1] = (s) => c.value.password = s),
          class: i(e.inputClass),
          required: ""
        }, null, 2), [
          [k, c.value.password]
        ...
        d(m).password.$errors.length ? (a(), l("div", {
          ...
          (a(!0), l(v, null, w(d(m).password.$errors, (s) => (a(), l("div", {
            key: s.$uid
          }, b(s.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
  ...
  emits: [E],
  setup(e, { emit: h }) {
    const f = e, y = h, u = q(""), c = q(crypto.randomUUID()), n = q({
      firstName: "",
      lastName: "",
      email: "",
      password: ""
      ...
      try {
        ...
        t.response?.status === 422 ? u.value = "User is already registered" : u.value = `${t}`;
      }
    };
    return K(() => {
      g.value.$touch();
      ...
      r("div", P, [
        ...
        d(g).firstName.$errors.length ? (a(), l("div", {
          ...
          (a(!0), l(v, null, w(d(g).firstName.$errors, (t) => (a(), l("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
      r("div", G, [
        ...
        d(g).lastName.$errors.length ? (a(), l("div", {
          ...
          (a(!0), l(v, null, w(d(g).lastName.$errors, (t) => (a(), l("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
      r("div", H, [
        ...
        d(g).email.$errors.length ? (a(), l("div", {
          ...
          (a(!0), l(v, null, w(d(g).email.$errors, (t) => (a(), l("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
      r("div", O, [
        ...
        d(g).password.$errors.length ? (a(), l("div", {
          ...
          (a(!0), l(v, null, w(d(g).password.$errors, (t) => (a(), l("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
  ...
  setup(e, { emit: h }) {
    ...
    return (n, m) => (a(), l("div", z, [
      ...
      r("div", J, [
        y.value ? (a(), l("p", Q, [
          m[0] || (m[0] = M(" Don't have an account? ", -1)),
          r("button", {
            onClick: c,
            class: i(e.linkClass)
          }, b(e.registrationButtonLabel), 3)
        ])) : (a(), l("p", W, [
          m[1] || (m[1] = M(" Do you have an account? ", -1)),
          r("button", {
            onClick: c,
            class: i(e.linkClass)
