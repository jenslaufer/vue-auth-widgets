...
import { ref as q, onMounted as K, createElementBlock as a, openBlock as r, Fragment as f, createElementVNode as l, createCommentVNode as p, normalizeClass as i, toDisplayString as b, withDirectives as $, unref as n, vModelText as k, renderList as N, createBlock as L, createTextVNode as M } from "vue";
import V from "axios";
import { useVuelidate as B } from "@vuelidate/core";
import { required as w, email as I, minLength as S } from "@vuelidate/validators";
const D = { class: "mb-4" }, R = { class: "mb-6" }, F = ["disabled"], U = "api-key-change", T = {
  ...
  emits: [U],
  setup(e, { emit: h }) {
    const v = e, y = h, m = q(""), g = q({
      email: "",
      password: ""
    }), d = B({
      email: { required: w, email: I },
      password: { required: w }
    }, g), u = (C) => {
      y(U, { key: C });
    }, x = async (C) => {
      ...
      const c = {
        ...
        "credentials.product": v.productName,
        password: g.value.password
      };
      try {
        let s, t;
        if (s = await V.get(`${v.baseUrl}/user?where=${encodeURIComponent(JSON.stringify(c))}`), !s.data._items || s.data._items.length === 0) {
          m.value = "Invalid login";
          return;
        }
    ...
    return K(() => {
      ...
      c[2] || (c[2] = l("h2", { class: "text-2xl font-bold mb-6 text-center" }, "Login", -1)),
      m.value ? (r(), a("p", {
        key: 0,
      ...
      l("div", D, [
        ...
        n(d).email.$errors.length ? (r(), a("div", {
          key: 0,
          class: i(e.errorMessageClass)
        }, [
          (r(!0), a(f, null, N(n(d).email.$errors, (s) => (r(), a("div", {
            key: s.$uid
          }, b(s.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
      l("div", R, [
        ...
        n(d).password.$errors.length ? (r(), a("div", {
          key: 0,
          class: i(e.errorMessageClass)
        }, [
          (r(!0), a(f, null, N(n(d).password.$errors, (s) => (r(), a("div", {
            key: s.$uid
          }, b(s.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
  ...
  emits: [E],
  setup(e, { emit: h }) {
    const v = e, y = h, m = q(""), g = q(crypto.randomUUID()), o = q({
      firstName: "",
      lastName: "",
      email: "",
      password: ""
    }), d = {
      firstName: { required: w, minLength: S(2) },
      lastName: { required: w, minLength: S(2) },
      email: { required: w, email: I },
      password: { required: w, minLength: S(8) }
    }, u = B(d, o), x = (c) => {
      y(E, { key: c });
    }, C = async (c) => {
      c.preventDefault(), m.value = "";
      ...
      try {
        let t;
        s.firstname = o.value.firstName, s.lastname = o.value.lastName, await V.post(`${v.baseUrl}/user`, s, {
          headers: { "Content-Type": "application/json" }
        }), t = s.key, x(t);
      } catch (t) {
        t.response?.status === 422 ? m.value = "User is already registered" : m.value = `${t}`;
      }
    };
    return K(() => {
      u.value.$touch();
      ...
      l("div", P, [
        ...
        n(u).firstName.$errors.length ? (r(), a("div", {
          ...
          (r(!0), a(f, null, N(n(u).firstName.$errors, (t) => (r(), a("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
      l("div", G, [
        ...
        n(u).lastName.$errors.length ? (r(), a("div", {
          ...
          (r(!0), a(f, null, N(n(u).lastName.$errors, (t) => (r(), a("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
      l("div", H, [
        ...
        n(u).email.$errors.length ? (r(), a("div", {
          ...
          (r(!0), a(f, null, N(n(u).email.$errors, (t) => (r(), a("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
      l("div", O, [
        ...
        n(u).password.$errors.length ? (r(), a("div", {
          ...
          (r(!0), a(f, null, N(n(u).password.$errors, (t) => (r(), a("div", {
            key: t.$uid
          }, b(t.$message), 1))), 128))
        ], 2)) : p("", !0)
      ]),
...
}, z = { class: "p-8 rounded-lg w-full max-w-2xl" }, J = { class: "mt-4 text-center" }, Q = {
  key: 0,
  class: "text-gray-600"
}, W = {
  key: 1,
  ...
  setup(e, { emit: h }) {
    ...
    return (o, d) => (r(), a("div", z, [
      ...
      l("div", J, [
        y.value ? (r(), a("p", Q, [
          d[0] || (d[0] = M(" Don't have an account? ", -1)),
          l("button", {
            onClick: g,
            class: i(e.linkClass)
          }, b(e.registrationButtonLabel), 3)
        ])) : (r(), a("p", W, [
          d[1] || (d[1] = M(" Do you have an account? ", -1)),
          l("button", {
            onClick: g,
            class: i(e.linkClass)
